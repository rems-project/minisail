(*<*)
theory Syntax
  imports  Introduction "Nominal2.Nominal2" "Nominal-Utils"
begin
(*>*)
...
text \<open>Syntax of MiniSail and contexts\<close>
...
atom_decl bv  (* Base-type variables *)
...
text \<open> Part of effort to make the proofs across cases more uniform by distilling the non-uniform parts into lemmas like this\<close>
lemma v_flip_eq:
