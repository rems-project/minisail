...
DIR="/home/markw/github/sail/test/typecheck"
SAILDIR="$DIR/../.."
MINISAIL="/home/markw/github/minisail/src/minisail -validate"
...
do
    if $MINISAIL  $DIR/pass/$i 2> /dev/null 1> $DIR/rtpass/$i;
    then
	if $MINISAIL $DIR/rtpass/$i 2> /dev/null 1> $DIR/rtpass2/$i;
	then
	...
	if $MINISAIL ${i%.sail}/$(basename $file) 2> result;
	then
